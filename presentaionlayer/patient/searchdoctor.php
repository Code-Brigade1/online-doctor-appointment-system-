...
<header>
	<h1>Doctor<span>Patient</span></h1>
		...
		<ul> 
			...
			<li><a class="active" href="searchdoctor.php">Search Doctor</a></li>
...
<form method="post" action="searchdoctor.php">
	...
	<div class="input-group">
		<label style="font-weight: bold; font-size: 30px ">Search By:</label><label style="font-weight: bold">* Doctor ID<br>* Doctor Name<br>* Categorey</label>
		<input type="text" name="dID" placeholder="Doctor Name" >
