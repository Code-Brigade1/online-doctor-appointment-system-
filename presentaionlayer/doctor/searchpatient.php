...
<header>
	<h1>Doctor<span>Patient</span></h1>
		...
		<ul> 
			...
			<li><a class="active" href=" searchpatient.php">Search Patient</a></li>
...
<form method="post" action="searchpatient.php" class="patientsearch">
	...
	<div class="input-group">
		...
		<input type="text" name="PID" placeholder="PatientID or Name" >
	...
	<div class="input-group">
		...
		<?php 
         ...
         ?>	<table class="table3" >
         	<caption style="margin-left: 34px; padding: 10px; font-weight: bold; font-size: 30px;" class="mys">Patient Information</caption>>
		...
		if(mysqli_num_rows($resultP)==1){
			while ($rowP=$resultP->fetch_assoc()) {
				...
				echo "<tr><td>".$rowP["UserID"]."</td><td>".$rowP["Name"]."</td><td>".$rowP["Address"]."</td><td>".$rowP["ContactNumber"]."</td><td>".$rowP['Email']."</td><td>".$rowP['Gender']."</td></tr>";
			}
