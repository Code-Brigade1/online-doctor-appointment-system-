...
if(count($errors)==0){
	...
	$sql = "INSERT INTO  patients (UserID, Name, Address, ContactNumber, Email, Password,Gender) VALUES ('$UserID','$Username','$Address','$ContactNumber','$Email','$Password','$Gender') ";
  ...
  printf("%d Row inserted.\n", $mysqli->affected_rows);
   ...
   // if(move_uploaded_file($_FILES['patients']))
